...
The first stage makes a research system and tests structural properties.
...
6. Record hypotheses, evidence, limits, and more experiments.
...
Future decoding experiments require a separate, frozen protocol.
